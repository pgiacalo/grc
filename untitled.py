...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tuning = tuning = 102.5e6
        self.samp_rate = samp_rate = 20e6
        self.rf_gain = rf_gain = 1
        self.output_gain = output_gain = 1
        self.if_gain = if_gain = 1
        self.channel_width = channel_width = 200e3
        self.channel_freq = channel_freq = tuning
        self.center_freq = center_freq = 98.0e6
        ...
        self._rf_gain_range = qtgui.Range(0, 20, 1, 1, 200)
        ...
        self._output_gain_range = qtgui.Range(0, 20, 1, 1, 200)
        self._output_gain_win = qtgui.RangeWidget(self._output_gain_range, self.set_output_gain, "output_gain", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._output_gain_win)
        self._if_gain_range = qtgui.Range(0, 20, 1, 1, 200)
        ...
        self._bb_gain_range = qtgui.Range(0, 20, 1, 1, 200)
        ...
        self._tuning_range = qtgui.Range(88e6, 108e6, 0.1e6, 102.5e6, 200)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(output_gain)
    ...
    def set_tuning(self, tuning):
        self.tuning = tuning
        self.set_channel_freq(self.tuning)
    ...
    def set_output_gain(self, output_gain):
        ...
        self.blocks_multiply_const_vxx_0.set_k(self.output_gain)
