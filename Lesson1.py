...
class Lesson1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lesson1", catch_exceptions=True)
        ...
        self._freq_range = qtgui.Range(-nyquist_rate, nyquist_rate, 1, 1000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, (self.samp_rate/2/self.decimate), (self.samp_rate/64), window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, (self.samp_rate/self.decimate))
