...
class Receive2_4_GHz(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Receive2_4_GHz", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Receive2_4_GHz")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Receive2_4_GHz")
        ...
        self.channel_width = channel_width = 20e6
        self.channel_freq = channel_freq = tuning
        self.center_freq = center_freq = 2440.0e6
        ...
        self._tuning_range = qtgui.Range(-40e6, 40e6, 1e6, 0, 200)
...
def main(top_block_cls=Receive2_4_GHz, options=None):
