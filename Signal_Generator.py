...
class Signal_Generator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._rf_gain_range = qtgui.Range(0, 47, 1, 0, 200)
        ...
        self._if_gain_range = qtgui.Range(0, 47, 0.3, 0, 200)
        ...
        self._frequency_range = qtgui.Range(1e6, 400e6, 1e6, 20e6, 200)
        ...
        self._bb_gain_range = qtgui.Range(0, 47, 0.3, 0, 200)
