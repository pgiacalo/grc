...
class GreatScottLesson1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GreatScottLesson1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GreatScottLesson1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GreatScottLesson1")
        ...
        self._bb_gain_range = qtgui.Range(0, 20, 1, 10, 200)
...
def main(top_block_cls=GreatScottLesson1, options=None):
